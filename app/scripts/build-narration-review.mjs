...
const SCREENS = [
  ...
  },
  {
    ...
    frameGroups: [
      ...
      },
      {
        ...
        frames: [
          ...
          { src: 'visit-step-count-ten', label: 'count to ten', at: 'last 12% — on "ten"' },
    ...
    events: [
      ...
      { kind: 'line', id: 'visit.countToTen', only: 'en', label: 'The ten-finger frame arrives 88% through, on the last number' },
