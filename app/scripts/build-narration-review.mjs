...
const SCREENS = [
  ...
  },
  {
    ...
    events: [
      ...
      { kind: 'gap', ms: 900, only: 'en' },
      { kind: 'line', id: 'visit.step.count', label: 'Eyes shut. Both languages, since 2026-09-05' },
      { kind: 'line', id: 'visit.countToTen', label: 'The ten-finger frame arrives 87% through, on the last number' },
