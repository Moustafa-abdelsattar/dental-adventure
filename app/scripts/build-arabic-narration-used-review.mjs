...
const entries = [
  ...
  },
  {
    ...
    note: 'Narration immediately after tapping the mask.',
  },
  {
    id: 'visit.handPrompt',
...
entries.push(
  ...[
    ...
    {
      id: 'prepare.intro',
      source: 'app/public/audio/ar/prepare.intro.mp3',
      target: 'app/public/audio/ar/prepare.intro.mp3',
      screenshot: '17-tooth-prep-start.png',
      frame: 'Tooth-prep simulation starts',
      note: 'Intro before the sleepy juice step.',
    },
    {
      id: 'prepare.step.spray',
      source: 'app/public/audio/ar/prepare.step.spray.mp3',
      target: 'app/public/audio/ar/prepare.step.spray.mp3',
      screenshot: '17-tooth-prep-start.png',
      frame: 'Sleepy juice step is active',
      note: 'Instruction to press the sleepy juice.',
    },
    {
      id: 'prepare.step.scrub',
      source: 'app/public/audio/ar/prepare.step.scrub.mp3',
      target: 'app/public/audio/ar/prepare.step.scrub.mp3',
      screenshot: '07-tooth-removing-decay.png',
      frame: 'Brush is ready and decay spots are clickable',
      note: 'Instruction to press each sticky spot.',
    },
    {
      id: 'visit.stopSignal',
